...
>Jawab: fungsi hitungLuas() harus memiliki return karena perlu menghitung luas dan harus mengirim nilainya kembali untuk ditampilkan dan dipakai fungsi lain, fungsi hitungVolume() harus punya return karena digunakan untuk menghasilkan nilai volume yang harus ditampilkan di main(), fungsi main() tidak perlu return karen hanya mengatur jalannya program dan tidak menghasilkan nilai untuk dikembalikan ke fungsi lain